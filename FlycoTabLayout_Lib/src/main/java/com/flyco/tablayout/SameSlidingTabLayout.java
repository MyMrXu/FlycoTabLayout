 ...
 */
public class SameSlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    private int mFitTextSelectColor;
    private int mFitTextUnselectColor;
    ...
    private ArrayList<String> mFitTitles = new ArrayList<>();

    public SameSlidingTabLayout(Context context) {
        this(context, null, 0);
    }

    public SameSlidingTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SameSlidingTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setViewPager(ViewPager vp, String[] titles, ArrayList<String> fitTitles) {
        if (!fitTitles.isEmpty()) {
            mFitTitles = fitTitles;
        }
        if (vp == null || vp.getAdapter() == null) {
            throw new IllegalStateException("ViewPager or ViewPager adapter can not be NULL !");
        }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.layout_subtitle_tab, null);
            CharSequence pageTitle = mTitles == null ? mViewPager.getAdapter().getPageTitle(i) : mTitles.get(i);
            CharSequence fitTitle = mFitTitles == null || i >= mFitTitles.size() ? "" : mFitTitles.get(i);
            addTab(i, pageTitle.toString(), fitTitle.toString(), tabView);
        }
    ...
    public void addNewTab(String title) {
        View tabView = View.inflate(mContext, R.layout.layout_subtitle_tab, null);
        if (mTitles != null) {
            mTitles.add(title);
        }
     ...
     * 创建并添加tab
     */
    private void addTab(final int position, String title, String fitTitle, View tabView) {
        TextView tv_tab_title = (TextView) tabView.findViewById(R.id.tv_tab_title);
        TextView tv_tab_fit_title = (TextView) tabView.findViewById(R.id.tv_tab_fit_title);
        if (tv_tab_title != null) {
            if (title != null) tv_tab_title.setText(title);
        }
        if (tv_tab_fit_title != null) {
            tv_tab_fit_title.setText(fitTitle);
        }
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            TextView tv_tab_fit_title = (TextView) v.findViewById(R.id.tv_tab_fit_title);

            if (tv_tab_title != null) {
                tv_tab_title.setTextColor(i == mCurrentTab ? mTextSelectColor : mTextUnselectColor);
                tv_tab_fit_title.setTextColor(i == mCurrentTab ? mFitTextSelectColor : mFitTextUnselectColor);
                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, mTextsize);
                tv_tab_fit_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, mFitTextsize);
                tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
                if (mTextAllCaps) {
                    tv_tab_title.setText(tv_tab_title.getText().toString().toUpperCase());
                    tv_tab_fit_title.setText(tv_tab_fit_title.getText().toString().toUpperCase());
                }

                if (mTextBold == TEXT_BOLD_BOTH) {
                    tv_tab_title.getPaint().setFakeBoldText(true);
                    tv_tab_fit_title.getPaint().setFakeBoldText(true);
                } else if (mTextBold == TEXT_BOLD_NONE) {
                    tv_tab_title.getPaint().setFakeBoldText(false);
                    tv_tab_fit_title.getPaint().setFakeBoldText(false);
                }
            }
        }
    }
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            TextView tab_fit_title = (TextView) tabView.findViewById(R.id.tv_tab_fit_title);

            if (tab_title != null) {
                tab_title.setTextColor(isSelect ? mTextSelectColor : mTextUnselectColor);
                tab_fit_title.setTextColor(isSelect ? mFitTextSelectColor : mFitTextUnselectColor);
                if (mTextBold == TEXT_BOLD_WHEN_SELECT) {
                    tab_title.getPaint().setFakeBoldText(isSelect);
                    tab_fit_title.getPaint().setFakeBoldText(isSelect);
                }
            }
        }
    }
    ...
    public void setFitTextsize(float textsize) {
        this.mFitTextsize = sp2px(textsize);
        updateTabStyles();
    }

    public void setFitTextSelectColor(int textSelectColor) {
        this.mFitTextSelectColor = textSelectColor;
        updateTabStyles();
    }

    public void setFitTextUnselectColor(int textUnselectColor) {
        this.mFitTextUnselectColor = textUnselectColor;
        updateTabStyles();
    }
